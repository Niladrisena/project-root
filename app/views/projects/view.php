<div class="max-w-7xl mx-auto pb-12 relative">
    ...
    <div class="border-b border-gray-200 mb-6">
        <nav class="flex gap-8" id="project-tabs">
            ...
            <button onclick="switchTab('revenue')" id="tab-btn-revenue" class="pb-4 text-sm font-bold border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-colors focus:outline-none">Revenue Management</button>
