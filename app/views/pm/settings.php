<div class="max-w-3xl mx-auto pb-12 px-4 md:px-0">
    ...
    <form action="<?= base_url('/pm/settings') ?>" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-8 space-y-6">
            ...
            <div>
                ...
                <input type="password" name="current_password" required placeholder="Enter your current password" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-gray-900 outline-none transition">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                <div>
                    ...
                    <input type="password" name="new_password" required placeholder="Minimum 8 characters" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-gray-900 outline-none transition">
                </div>
                <div>
                    ...
                    <input type="password" name="confirm_password" required placeholder="Retype new password" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-gray-900 outline-none transition">
                </div>
            </div>
            
            <div class="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-100">
                <p class="text-xs text-blue-800 font-medium leading-relaxed">
                    <span class="font-bold uppercase tracking-wider">Security Tip:</span> Use a combination of uppercase letters, lowercase letters, numbers, and symbols. You will remain logged in after updating your password.
                </p>
            </div>
        </div>

        <div class="bg-gray-50 px-8 py-5 border-t border-gray-100 flex justify-end">
            <button type="submit" class="px-8 py-3.5 bg-gray-900 hover:bg-black text-white font-black rounded-xl shadow-md transition flex items-center gap-2">
